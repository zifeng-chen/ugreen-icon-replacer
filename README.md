...
- ✅ **原图标自动备份**：替换自定义图标时，原始图标保留为 `.bak` 后缀备份文件，可随时恢复
...
| 2    | 锤子 OS          | Sunny 整理 + 陈子疯迭代，极简细腻 |
| 3    | 拟物毛玻璃       | Sunny 制作，冰感拟物         |
| 4    | 绿联毛玻璃       | Sunny 制作，更绿、更毛、更玻璃 |
| 5    | 官方默认图标     | 恢复原始图标样式             |

> 💡 **锤子 OS 主题**目前由陈子疯持续迭代中，已自定义优化的图标包括：安全管家、迅雷、帮助中心、UGREEN AI、回收站、下载中心等。
...
### v1.4.1 (2026-05-29) by 陈子疯
- 📥 新增下载中心自定义图标（锤子 OS 主题）
- 💾 自定义图标替换时自动备份原文件（`.bak` 后缀）
- 📝 README 补充锤子 OS 迭代说明与备份机制介绍
